    ...
    <div class="container">
      <div class="offer-block wow fadeInLeft" data-wow-delay="0.2s">
        ...
        <form id="offer-form" action="mail.php" method="POST" class="form offer-form">
          ...
          <input class="input offer-block__input" name="username" type="name" placeholder="Ваше имя">
          <input class="input offer-block__input phone" name="phone" type="tel" placeholder="Ваш телефон">
          <button class="button offer-block__button">
  ...
  <section class="section feature">
    ...
    <div class="container">
      <div class="feature-block">
        ...
        <div class="features">
          <p class="features__text">Мы дадим Вам максимальные скидки у наших партнеров для закупки материалов оптом</p>
          <div class="features__img"><img src="img/feature/feature-img-2.png" alt=""></div>
        </div>
        <div class="features">
          <p class="features__text">Все, что не сможете найти в городе - поможем заказать у проверенных поставщиков</p>
    ...
    <div class="container">
      <div class="brif-block">
        <div class="brif__interview">
          ...
          <spn class="interview__subtitle">Для этого нужно ответить на 4 вопроса:</spn>
